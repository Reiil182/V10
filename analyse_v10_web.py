...
def analyser_v10_logic(df_v10, df_plume):
    ...
    for _, row in df_v10.iterrows():
        ...
        # Modification : Recherche insensible à la casse avec re.IGNORECASE
        ...
        if is_t_exit: 
            ...
            # Modification : Logique de sélection de la raison
...
with tab_v10:
    ...
    if st.button("LANCER L'ANALYSE V10", type="primary"):
        if file_v10:
            ...
            # Message de succès avec le nombre de cas détectés
